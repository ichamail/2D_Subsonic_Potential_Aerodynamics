...
from panel_method.mesh_class import AeroPanelMesh, SurfacePanelMesh
...
if __name__=="__main__":
    ...
    from solver import simulate_flow_around_a_2D_circular_object, simulate_steady_flow_around_an_Airfoil, simulate_unsteady_flow_around_an_Airfoil
